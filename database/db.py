...
from database.models.reward import Reward, INITIAL_REWARDS # Nueva importación

DATABASE_URL = settings.DATABASE_URL

Base = declarative_base()
engine = create_async_engine(DATABASE_URL, echo=False) # echo=True para ver las queries SQL
...
async def insert_initial_data(session: AsyncSession):
    ...
    # Insertar recompensas (Nueva Sección)
    from sqlalchemy.future import select # Importar select aquí para evitar circular import si ya existe
